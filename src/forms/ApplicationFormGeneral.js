...
const ApplicationFormGeneral = ({ handleSubmit, invalid, cities }) => (
  <form autoComplete="off" className="applicationForm" onSubmit={handleSubmit}>
    <p>
      So, you're interested in volunteering for CodeYourFuture? Fantastic! We
      just need a few pieces of information to help us get organised and welcome
      you.
    </p>
    <ShortAnswerQuestion
    ...
    <CheckboxesQuestion
      ...
      name="interests"
      options={{
        "teachingCode" : "Teaching code or agile methodologies",
        "runningOrganisation" : "Running and growing the organisation"
      }}
      isRequired={true}
    />
    <ButtonGroup>
